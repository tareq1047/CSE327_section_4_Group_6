...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@redroofinn.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+8808171524-27</li>
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Red Roof <span>Inn</span><p class="logo_w3l_agile_caption">Your best destination in Comilla</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">Red Roof inn</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							<span class="cbp-ig-icon w3_cube"></span>
							<h4 class="cbp-ig-title">City View balcony</h4>
							<span class="cbp-ig-category">Red roof Inn</span>
						</div>
					</li>
					<li>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our Red Roof Inn</h3>
						   <p class="about-para-w3ls">Red Roof Inn is the latest casualty in luxury hotel and Resturant in the Comilla City. The Red Roof Inn offering excellent Bangla, Indian, Thai and Chinese Food and Residential facility.</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
										<div class="w3l-slider-img">
											<img src="images/a1.jpg" class="img-responsive" alt="Hair Salon">
										</div>
                                       <div class="w3ls-info-about">
										    <h4>We offer the best hotel experince in comilla</h4>
											<p>We gurantee that you will love our stay here.</p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					<i class="fa fa-credit-card" aria-hidden="true"></i>
			 		...
			 		<p>Red Roof Inn is the latest casualty in luxury hotel in the Comilla City. We are offering prix fixe menus like Bangla, Indian, Thai and Chinese..</p>
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					<i class="fa fa-clock-o" aria-hidden="true"></i>
			 		...
			 		<p>The Chairmen said it is closing Red Roof Inn as part of a repositioning of its food and beverage options. Its casual restaurant will remain open and new dining plans will be announced in coming months, it said, declining further comment.</p>
			...
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>MD Tareq Mahmud Khan</h4>
							<span>Manager</span>
							<p>He has a good working background in the industry for 10 years. Managed all the responsibolites in a best way for the hotel.</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+08171524-27</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">info@redroofinn.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> 358 jhawtala , kandirpar road, Comilla</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2018 CSE_327_group_6 . All Rights Reserved | Design by <a href="index.php"> CSE_327_group_6</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
