...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">redroofin@redroofin.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+8808171524</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Hoted red roff  <span>inn</span><p class="logo_w3l_agile_caption">Perfect accomadation</p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#team" class="menu__link scroll">Faboulous team</a></li>
							<li class="menu__item"><a href="#gallery" class="menu__link scroll">Our gallery </a></li>
							<li class="menu__item"><a href="#rooms" class="menu__link scroll">Accomanadation </a></li>
					...
					<li>
						<div class="w3layouts-banner-top w3layouts-banner-top1">
							<div class="container">
								<div class="agileits-banner-info">
								<h4>Red roof inn</h4>
									<h3>Stay with friends anf family </h3>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our Red roff inn</h3> 
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+8801674979197</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INo@Redroofinn.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> jhawtala road,kandirpar,comilla, bangladesh</p>
